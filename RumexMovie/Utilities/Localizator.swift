...
extension String {
    ...
    static let MyPet = NSLocalizedString("This is my pet - Create pet profile", comment: "")
    static let OthersPet = NSLocalizedString("This not my pet - Add an other pet post", comment: "")
    ...
    static let MovieDetailVC = NSLocalizedString("MovieDetailVC", comment: "")
...
//    static let StepOneNC = NSLocalizedString("StepOneNC", comment: "")
